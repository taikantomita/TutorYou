...
export default function StudentDashboard() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        console.log('Profile Created:', { name, email, subjects, profilePicture })
    }
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 p-8">
            ...
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-3xl space-y-6">
                ...
                <div>
                    <label className="block text-gray-700 dark:text-gray-300">Preferred Subjects</label>
                    <input
                        type="text"
                        value={subjects}

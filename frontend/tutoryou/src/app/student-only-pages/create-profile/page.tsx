    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 p-8">
            ...
            >
                ...
                <div>
                    <label className="block text-lg text-gray-700 dark:text-gray-300 mb-2">Preferred Subjects</label>
                    <div className="grid grid-cols-2 gap-2">
                        {["Mathematics", "Science", "History", "Literature", "Art", "Physical Education", "Music", "Computer Science"].map(
                            (subject) => (
